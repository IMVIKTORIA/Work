...
function CustomList<SearchDataType = any, ItemType = any>(
  ...
  return (
    <div className="custom-list-uikit">
      <div
        className={
          isScrollable
            ? "custom-list-uikit__header custom-list-uikit__header_scrollable"
            : "custom-list-uikit__header"
        }
        ref={headerRef}
      >
      ...
      <div
        className={
          isScrollable
            ? "custom-list-uikit__body_scrollable"
            : "custom-list-uikit__body"
        }
        style={{ height: height }}
        ref={bodyRef}
        onScroll={onScroll}
      >
        <div
          className="custom-list-uikit__body-wrapper"
          //   style={
          //     listWidth
